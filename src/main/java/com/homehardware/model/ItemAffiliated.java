...
/**
 * ItemAffilated generated by hbm2java.
 */
@Entity
...
public class ItemAffiliated implements java.io.Serializable {
        ...
        public ItemAffiliated(final String item, final String itemAffiliated,
        ...
        @Column(name = "ITEM_AFFILIATED", length = Constant.int_64)
        public final String getItemAffiliated() {
                return this.itemAffiliated;
        }

        public final void setItemAffiliated(final String itemAffiliated) {
                this.itemAffiliated = itemAffiliated;
        }
