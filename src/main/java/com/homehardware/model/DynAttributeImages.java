...
/** DynAttributeImages generated by hbm2java.
 */
@Entity
@Table(name = "dyn_attribute_images", catalog = "ignitiv")
@CsvRecord(separator = "\\|", skipFirstLine = true)
public class DynAttributeImages implements java.io.Serializable {
        ...
        public DynAttributeImages() {
        }

        public DynAttributeImages(final Integer dynAttrId, final String dynAttrDesc, 
              final String dynAttrDescFr, final Integer imageId,
              final Integer language, final String isProcessSuccess, 
        ...
        @Column(name = "DYN_ATTR_DESC", length = Constant.int_50)
        ...
        @Column(name = "DYN_ATTR_DESC_FR", length = Constant.int_50)
        public final String getDynAttrDescFr() {
                return this.dynAttrDescFr;
        }
      
        public final void setDynAttrDescFr(final String dynAttrDescFr) {
                this.dynAttrDescFr = dynAttrDescFr;
        }
