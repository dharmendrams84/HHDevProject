...
public class RetailMsrp implements java.io.Serializable {
	...
	public RetailMsrp(String item, Integer store, BigDecimal retailMsrp, String isProcessSuccess, Integer errorCode,
	...
	@Column(name = "RETAIL_MSRP", precision = 10)
	public BigDecimal getRetailMsrp() {
		return this.retailMsrp;
	}

	public void setRetailMsrp(BigDecimal retailMsrp) {
		this.retailMsrp = retailMsrp;
	}
