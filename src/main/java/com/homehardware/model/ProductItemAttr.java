...
public class ProductItemAttr implements java.io.Serializable {
        ...
        public ProductItemAttr(final String productAttrId, final String item) {
         ...
         */
        public ProductItemAttr(final String productAttrId, final String item,
                        final String attributeValue, final String attributeValueFr,
        ...
        @Column(name = "PRODUCT_ATTR_ID", nullable = false, length = Constant.int_64)
        ...
        @Column(name = "ITEM", nullable = false, length = Constant.int_64)
