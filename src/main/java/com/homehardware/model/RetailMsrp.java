...
/**
 * RetailMsrp generated by hbm2java.
 */
@Entity
@Table(name = "retail_msrp", catalog = "ignitiv")
@CsvRecord(separator = "\\|", skipFirstLine = true)
public class RetailMsrp implements java.io.Serializable {
        ...
        public RetailMsrp(final String item, final Integer store, final Double retailMsrp,
        ...
        @Column(name = "RETAIL_MSRP", precision = Constant.int_10)
        public final Double getRetailMsrp() {
                return this.retailMsrp;
        }

        public final void setRetailMsrp(final Double retailMsrp) {
                this.retailMsrp = retailMsrp;
        }
