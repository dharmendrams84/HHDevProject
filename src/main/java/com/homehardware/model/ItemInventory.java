...
public class ItemInventory implements java.io.Serializable {
        ...
        public ItemInventory(final String item, final String loc, final String quantity,
        ...
        @Column(name = "ITEM", length = Constant.int_20)
        ...
        @Column(name = "LOC", length = Constant.int_10)
        public final String getLoc() {
                return this.loc;
        }

        public final void setLoc(final String loc) {
                this.loc = loc;
        }

        @Column(name = "QUANTITY", length = Constant.int_10)
