// default package
// Generated Jan 8, 2018 4:30:31 PM by Hibernate Tools 5.2.6.Final
...
public class ProductAttr implements java.io.Serializable {
	...
	public ProductAttr(int prodAttrId) {
		this.prodAttrId = prodAttrId;
	}

	public ProductAttr(int prodAttrId, String attributeName, String attributeNameFr, String isProcessSuccess,
	...
	@Column(name = "PROD_ATTR_ID", nullable = false)
	public int getProdAttrId() {
