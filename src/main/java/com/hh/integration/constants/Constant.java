package com.hh.integration.constants;
...
public class Constant {
	...
	public static final int int_65535 = 65535;
	
	public static final String TENANT = "tenant~";
	public static final int master_catalog_id = 2;
	...
	public static final String tenant_marketing_description = "tenant~marketing-description";
	public static final String TENANT_INGREDIENTS = "tenant~ingredients";
	public static final String MKTG = "Mktg";
	public static final String INGR = "Ingr";
	public static final String FB = "Fb";
	public static final String FULL_PATH_NAME = "EHF-TEMPLATE" + "@" + "HomeH";
	/*24094 24218*/
	public static final int tenantId = 24094 ;
	//35909 36263
	public static final int siteId = 35909  ;
