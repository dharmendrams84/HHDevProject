...
CREATE TABLE `dyn_attr_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `DYN_ATTR_TYPE` varchar(100) DEFAULT NULL,
  `IS_PROCESS_SUCCESS` varchar(1) DEFAULT 'F',
  `ERROR_CODE` int(11) DEFAULT NULL,
  `ERROR_DESC` text,
  `BATCH_ID` varchar(50) DEFAULT NULL,
  ...
  `UPDATE_BY` varchar(50) DEFAULT NULL,
  `UPDATE_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `DYN_ATTR_ID` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=553 DEFAULT CHARSET=utf8;

CREATE TABLE `product_item_attr` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `PRODUCT_ATTR_ID` int(11) NOT NULL,
  `ITEM` varchar(64) NOT NULL,
  `ATTRIBUTE_VALUE` varchar(64) DEFAULT NULL,
  `ATTRIBUTE_VALUE_FR` varchar(64) DEFAULT NULL,
  `IS_PROCESS_SUCCESS` varchar(1) DEFAULT 'F',
  `ERROR_CODE` int(11) DEFAULT NULL,
  `ERROR_DESC` text,
  `BATCH_ID` varchar(50) DEFAULT NULL,
  ...
  `UPDATE_DATE` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=372369 DEFAULT CHARSET=utf8;

CREATE TABLE `product_attr` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `PROD_ATTR_ID` int(11) NOT NULL,
  `ATTRIBUTE_NAME` varchar(64) DEFAULT NULL,
  `ATTRIBUTE_NAME_FR` varchar(64) DEFAULT NULL,
  `IS_PROCESS_SUCCESS` varchar(1) DEFAULT 'F',
  `ERROR_CODE` int(11) DEFAULT NULL,
  `ERROR_DESC` text,
  `BATCH_ID` varchar(50) DEFAULT NULL,
